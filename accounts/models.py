...
class Movie(models.Model):
    ...
    movie_rdate=models.DateField(max_length=20, default="null")
...
class Shows(models.Model):
    ...
    date=models.DateField(max_length=15, default="")
    price=models.IntegerField()

    def __str__(self):
        return self.cinema.cinema_name +" | "+ self.movie.movie_name 
